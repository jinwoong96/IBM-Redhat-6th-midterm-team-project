...
class Effects(Base):
    ...
    flu_min: Mapped[float] = mapped_column(Float,CheckConstraint("flu_min>= -15"),nullable=False)
    flu_max: Mapped[float] = mapped_column(Float,CheckConstraint("flu_max<=15 "),nullable=False)
