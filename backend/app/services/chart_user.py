...
class ChartuserService:
    ...
    @staticmethod
    async def get_chartuser(up_date:int,user_id:int,current_user_id:int,db:AsyncSession):
    ...
    @staticmethod
    async def add_chartuser(user_id:int,chart:ChartuserUpdate,db:AsyncSession):
        # user_id 잇는지 확인 (예외처리)
